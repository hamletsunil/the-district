...
const SOURCES: Source[] = [
  ...
  { title: "Hamlet — Search local government meetings", outlet: "Hamlet", url: "https://www.myhamlet.com/search?q=piedmont&utm_source=district&utm_medium=internal&utm_content=sources" },
];
    ...
    <section className="pm-editorial-section">
      ...
      <FadeIn delay={200}>
        <div className="pm-body-prose" style={{ marginTop: "2rem" }}>
          <p>
            The pickleball hearing was one of <a href="https://www.myhamlet.com/search?q=piedmont&utm_source=district&utm_medium=internal&utm_content=prose" target="_blank" rel="noopener noreferrer">{DATA.summary.totalMeetings} public meetings</a>{" "}
        ...
        <FadeIn delay={300}>
          <div className="pm-body-prose">
            <p>
              ...
              <a href="https://www.myhamlet.com/search?q=piedmont+school+board+budget&utm_source=district&utm_medium=internal&utm_content=prose" target="_blank" rel="noopener noreferrer">school
        ...
        <FadeIn delay={500}>
          <div className="pm-body-prose">
            <p>
              ...
              >
                September 18, 2023
              </a>, the <a href="https://www.myhamlet.com/search?q=piedmont+city+council&utm_source=district&utm_medium=internal&utm_content=prose" target="_blank" rel="noopener noreferrer">City Council</a> heard from an Oakland woman during a
...
export default function PiedmontsDeliberation() {
  ...
  return (
    <main className="pm-article article-page" data-theme="piedmont">
      ...
      <ArticleEndCTA cityName="Piedmont" hamletSearchUrl="https://www.myhamlet.com/search?q=piedmont&utm_source=district&utm_medium=internal&utm_content=article-end-cta" />
