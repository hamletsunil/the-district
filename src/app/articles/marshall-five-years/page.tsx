  ...
  return (
    <FadeIn className="mf-section">
      <div className="mf-body-prose">
        <p>
          &ldquo;Act of God&rdquo; is a phrase with two meanings. Colloquially, it names a disaster that is sudden, large, and unpredictable. In insurance law, it names an event with no human agent to sue. The Marshall Fire, which ignited in grassland near the Marshall Mesa Trailhead on the morning of December 30, 2021, qualified under the first definition. It did not qualify under the second.
        </p>
        <p>
        ...
        <p>
          Xcel Energy, whose power line Boulder County investigators identified as the most probable cause of the primary ignition, announced a ${DATA.xcelSettlement.settlementAmount} million settlement in September 2025 without admitting fault. By January 2026, nearly all {DATA.xcelSettlement.plaintiffCount.toLocaleString()} plaintiffs had signed. Colorado&rsquo;s Division of Insurance put the average underinsurance gap at between ${DATA.insurance.gapAt250Sqft.toLocaleString()} and ${DATA.insurance.gapAt350Sqft.toLocaleString()} per policy, depending on the per-square-foot assumption. Insurance, the fight everyone expected to dominate the council chamber, left it within a year.
        </p>
        <p>
