 ...
 *
 * Social sharing buttons for X, LinkedIn, and Facebook.
 * Consistent with The District's dark theme design.
 */
...
export function SocialShare({ title, className }: SocialShareProps) {
  ...
  const shareText = title || "Check out this article from The District";
  ...
  return (
    <section className={`social-share ${className || ""}`}>
      <div className="social-share__container">
        <span className="social-share__label">Share this article</span>
